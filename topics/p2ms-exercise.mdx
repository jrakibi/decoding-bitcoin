...
<h1 className="text-2xl font-bold mb-4">P2MS ScriptPubKey Decompiler</h1>
<div className="mb-4">
...
<h2 className="text-xl font-semibold">Decompiled Result:</h2>
<p className="mt-2"><strong>Required Signatures:</strong> {result.requiredSignatures}</p>
<div className="mt-2">
