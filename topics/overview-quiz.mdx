...
<p className='text-gray-300'>Input: <span className='font-mono text-orange-400'>{result.input}</span></p>
<p className='text-gray-300'>Expected: <span className='font-mono text-orange-400'>{result.expected}</span></p>
<p className='text-gray-300'>Result: <span className='font-mono text-orange-400'>{result.result}</span></p>
</div>
</div>
)}
</div>
